...
<%
	...
	List<HashMap<String, Object>> resultList = (List<HashMap<String, Object>>) request.getAttribute("resultList");
	HashMap<Integer, List<CommentsDTO>> commentMap = (HashMap<Integer, List<CommentsDTO>>) request.getAttribute("commentMap");
...
<div class="user-info-zone">
	<div class="postWrapper">
		<div class="layer-post" id="layerSearch">
			<div class="search-input">
				<span>Recommend For @<%= loginUserId %></span>
			</div>
			<div class="search-for">
				...
				<span>Style: </span>
				<%
					for(String userStyle: styleList){
				%>
				<span><%= userStyle %></span>
				<% } %>
			</div>
...
<div class="user-post-zone">
	...
	<%
		...
		for (HashMap<String, Object> postDTO : resultList) {
			int idx = ((BigDecimal)postDTO.get("IDX")).intValue();
			String userid = (String)postDTO.get("USERID");
			String style = (String)postDTO.get("STYLE");
			String photo = (String)postDTO.get("PHOTO");
			String content = (String)postDTO.get("CONTENT");
			int likes = ((BigDecimal)postDTO.get("LIKES")).intValue();
			String writeday = (String)postDTO.get("WRITEDAY");
